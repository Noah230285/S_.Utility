...
{
    public class ClampedFloatElement : VisualElement
    {
        ...
        FloatReferenceField _currentReferenceField;
        FloatReferenceField _maxReferenceField;
        ...
        #region
        public new class UxmlFactory : UxmlFactory<ClampedFloatElement> { }
        public ClampedFloatElement()
        {
            Inititialize();
        }
        #endregion

        public ClampedFloatElement(SerializedProperty property)
        {
            Inititialize();
            Configure(property);
        }
        ...
        void Inititialize()
        {
            this.LoadFromUXML("Assets/Editor/UIToolkit/UXML/Templates/ClampedFloatUXML.uxml");
            ...
            _currentReferenceField = this.Q<FloatReferenceField>("CurrentVariable");
            _maxReferenceField = this.Q<FloatReferenceField>("MaxVariable");
        }
